...
public class GvrWindowsSimulator : MonoBehaviour
{
    ...
    private static GvrWindowsSimulator instance;
    ...
    public static GvrWindowsSimulator Instance
    {
        get
        {
            if (instance == null && !instanceSearchedFor)
            {
                instance = FindObjectOfType<GvrWindowsSimulator>();
    ...
    public void UpdateEditorEmulation()
    {
        ...
        if (CanChangeYawPitch())
        {
            ...
            mouseX = Mathf.Clamp(mouseX, -85, 85);
